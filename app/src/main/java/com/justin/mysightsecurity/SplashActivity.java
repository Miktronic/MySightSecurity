...
//                db.execSQL("DROP TABLE IF EXISTS History");
                ...
                String query_device = "CREATE TABLE IF NOT EXISTS Device (id INTEGER PRIMARY KEY AUTOINCREMENT, ip_address Text, port Text,device_id Text, ico_url Text,password Text)";
...
//                deviceVal.put("device_id", "admin");
//                deviceVal.put("ico_url", "horse");
//                deviceVal.put("password", "123456");
//
//                try {
