    ...
    public void run() {
        ...
        while (!Thread.currentThread().isInterrupted()) {
            ...
            try {
                ...
                if(Global.newDeviceId.equals(Global.requestedDevicedId))
                {
...
//                        val.put("device_id", getArguments().getString("device_id"));
                            ...
                            val.put("device_id", Global.newDeviceId);
                            val.put("ico_url", "horse");
                            val.put("password",Global.password);
